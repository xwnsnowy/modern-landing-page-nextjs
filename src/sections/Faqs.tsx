      ...
      <div className="container">
        ...
        <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
          {faqs.map((faq, faqIndex) => (
            <div
              key={faq.question}
              className="bg-neutral-900 rounded-2xl border border-wihte/10 p-6"
            >
              <div
                className="flex justify-between items-center"
                onClick={() => handleFaqClick(faqIndex)}
              >
                ...
                <svg
                  ...
                  className={twMerge(
                    "feather feather-plus text-lime-400 flex-shrink-0 cursor-pointer hover:text-lime-500",
              ...
              >
                <p className="text-primary-foreground/50">{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
